...
JPanel header;
int accno1,color;
SearchResult(String title,int accno,String result,int v)
{
    color=v;
accno1=accno;
...
{
SearchResult obj=new SearchResult("SearchResult",0,"null",0);
} 
...
{
SearchResult.this.exitaudio();  
SearchResult.this.hideFrame();
}
if(btnop.getSource()==back)
{
SearchResult.this.backaudio();    
