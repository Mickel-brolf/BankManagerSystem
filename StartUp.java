...
changethemecolor=new JButton("CHANGE COLOR");
...
{
StartUp obj=new StartUp("HOME",0);
}
...
{
SignUp obj=new SignUp("Create Account",color);
StartUp.this.backaudio();
StartUp.this.hideFrame();
}
